...
export function transformBenefit(dbBenefit: BenefitWithServices): TransformedBenefit {
  return {
    ...
    periodMonths: dbBenefit.period_months,
    ...
    appScheme: dbBenefit.app_scheme || undefined,
    eligibleServices: dbBenefit.benefit_eligible_services?.map(service => service.service_name) || [],
